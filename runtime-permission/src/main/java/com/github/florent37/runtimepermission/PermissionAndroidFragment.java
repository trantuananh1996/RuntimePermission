 ...
 */
public class PermissionAndroidFragment extends Fragment {
    ...
    @Nullable
    private PermissionFragment.PermissionListener listener;

    public PermissionAndroidFragment() {

    }

    public static PermissionAndroidFragment newInstance(List<String> permissions) {
        final Bundle args = new Bundle();
        args.putStringArrayList(LIST_PERMISSIONS, new ArrayList<String>(permissions));
        final PermissionAndroidFragment fragment = new PermissionAndroidFragment();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE && permissions.length > 0 && this.listener != null) {
            final PermissionFragment.PermissionListener listener = this.listener;
    ...
    public PermissionAndroidFragment setListener(@Nullable PermissionFragment.PermissionListener listener) {
